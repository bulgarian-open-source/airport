...
import sofia.webapp.WebUiResources;
import sofia.dbsetup.HibernateSetup;
import sofia.filter.NoDataFilter;
import sofia.ioc.WebApplicationServerModule;
...
/**
 * Configuration point for Sofia Airport Asset Management Web Application.
 * 
 * @author Generated
 * 
 */
        ...
        try {
            ...
            getDefaultHost().attach(
                    new WebUiResources(
                            ...
                            injector,
                            "Sofia Airport Asset Management",
                            "An application server for Sofia Airport Asset Management",
                            "Sofia Asset Management Pty. Ltd.",
                            "Authors",
                            webApp
                            ));
